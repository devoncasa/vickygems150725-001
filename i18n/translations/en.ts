export const translations = {
    ...
    'glossary_def_fossil_resin': 'The scientific term for amber. It is tree resin that has, over millions of years, undergone a process of polymerization and hardening, transforming it from a soft, sticky substance to a hard, stable gem.',
    'glossary_term_gia': 'GIA',
    'glossary_def_gia': 'The Gemological Institute of America. One of the world\'s foremost authorities on gemology, known for its strict grading standards and comprehensive certification reports for diamonds and colored gems.',
    ...
    'glossary_def_heirloom_quality': 'A term used to describe jewelry of exceptional quality and durability, crafted to last for generations. It implies the use of high-grade materials and superior craftsmanship, making it suitable to be passed down as a family treasure.',
    ...
    'glossary_def_mohs_hardness': 'A scale from 1 to 10 that characterizes the scratch resistance of various minerals. A higher number indicates a harder material. For example, Diamond is a 10, Ruby is a 9, and Burmese Amber is around 2.5-3.',
    ...
    'glossary_def_pigeon_blood': 'A descriptive term for the most sought-after color in rubies. It refers to a pure, vivid red with a slight purplish-blue hue, resembling the color of a freshly killed pigeon\'s blood. This term is most famously associated with rubies from Mogok, Myanmar.',
    'glossary_term_topical_authority': 'Topical Authority',
    'glossary_def_topical_authority': 'An SEO concept where a website is recognized by search engines as a definitive expert on a specific subject. This is achieved by creating comprehensive, high-quality, and interlinked content that covers all aspects of a topic, much like this glossary does for gems.',
    ...
    'custom_rosary_intro': 'The Rosary is more than just a beautiful piece of jewelry; it is a profound tool for prayer and meditation within the Catholic tradition. Creating a custom Rosary allows you to select materials that resonate with your personal faith and intentions, making it a powerful and unique spiritual companion.',
    'custom_rosary_history_title': 'A Tradition of Contemplation',
    'custom_rosary_history_p1': 'The Rosary has been a cherished devotional practice for centuries, guiding the faithful through the contemplation of the mysteries of Jesus Christ\'s life, death, and resurrection, through the eyes of the Virgin Mary.',
    ...
    'custom_rosary_materials_p1': 'The choice of material for your Rosary can deepen its personal significance. We offer a curated selection of high-quality gemstones and natural materials, each with its own spiritual resonance.',
    'custom_rosary_materials_p2': 'Whether you are drawn to the loving energy of Rose Quartz, the celestial wisdom of Lapis Lazuli, or the calming presence of Howlite, you can create a Rosary that is not only beautiful but also a true reflection of your devotion.',
    ...
    'seo_custom_tesbih_desc': 'Design your own personal Tesbih (Tasbih, Misbaha) for dhikr. Choose from sacred materials like Agarwood (Oud), Jade, Lapis Lazuli, and rare Burmese Amber.',
    ...
    'custom_tesbih_intro': `The Tesbih (also known as Tasbih or Misbaha) is an intimate and essential tool for dhikr (the remembrance of Allah). Crafting a custom Tesbih allows you to choose materials that are not only aesthetically pleasing but also hold personal and spiritual significance, enhancing your devotional practice.`,
    ...
    'custom_tesbih_materials_p1': 'The material of your Tesbih can profoundly influence its feel, scent, and energetic properties. We offer a selection of revered materials known for their spiritual significance and natural beauty.',
    ...
    'custom_tesbih_cta_subtitle': 'Use our builder to create a Tesbih that reflects your personal taste and deepens your connection to your faith. Select your materials and design to create a timeless piece for yourself or a meaningful gift.',
    ...
    'seo_tesbih_rosary_builder_desc': 'Design your own custom Tesbih (Tasbih) or Catholic Rosary with our intuitive builder. Choose from a wide range of precious materials and create a unique spiritual piece.',
    ...
    'tesbih_rosary_builder_page_subtitle': 'Craft a unique Tesbih or Rosary that reflects your personal faith and style. Select your tradition, materials, and specifications to create a timeless spiritual tool.',
    ...
    'pbc_submit_quote': 'Submit for a Quote',
    ...
    'seo_prayer_bead_customizer_keywords': 'prayer bead customizer, build a rosary, build a tasbih, custom rosary, custom tasbih, personalized prayer beads, catholic gifts, islamic gifts',
    ...
    'seo_juzu_builder_desc': 'Design a traditional Japanese Juzu (prayer beads). Choose gender style, formal or informal type, and authentic materials for your personal spiritual tool.',
